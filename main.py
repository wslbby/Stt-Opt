...
def parse_config():
    ...
    # parser.add_argument('--checkpoint', type=str, default='./lightning_logs/version_318/checkpoints/last.ckpt', help='checkpoint location')
...
if not cfg.test:
    ...
    # init trainer
    trainer = pl.Trainer(gpus=-1, max_epochs=cfg.epoch, resume_from_checkpoint=cfg.checkpoint,
